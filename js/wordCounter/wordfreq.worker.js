...
// Release 2 (substantially revised) by Christopher McKenzie, Aug 2009
    var stemmer = function () {
        var g = {
            ...
            biliti: "ble",
            logi: "log"
        }, h = {icate: "ic", ative: "", alize: "al", iciti: "ic", ical: "ic", ful: "", ness: ""};
        return function (a) {
            var d, b, e, c, f;
            ...
            c = /^(.+?)(ss|i)es$/;
            b = /^(.+?)([^s])s$/;
            if (c.test(a)) a = a.replace(c, "$1$2"); else if (b.test(a)) a = a.replace(b, "$1$2");
            c = /^(.+?)eed$/;
            b = /^(.+?)(ed|ing)$/;
            if (c.test(a)) {
                b = c.exec(a);
                ...
                if (b.test(d)) {
                    ...
                    if (b.test(a)) a += "e"; else if (f.test(a)) {
                        c = /.$/;
                        a = a.replace(c, "")
    ...
    if (typeof define === 'function' && define.amd) {
         ...
         */
        if (('self' in global) && !(('window' in global) && window === global) && !self.onmessage && self.postMessage && self.importScripts) {
            var wordfreqsync;
